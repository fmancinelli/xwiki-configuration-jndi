...
/**
 * This configurations source wraps the {@link XWikiPropertiesConfigurationSource} and allows to override settings in
 * the xwiki.properties file using JNDI. If a property is found in the JNDI context, then its value is used, otherwise
 * the value from the xwiki.properties is used.
 *
 * @version $Id$
 */
@Component
...
@Singleton
public class XWikiPropertiesJNDIConfigurationSource extends XWikiPropertiesConfigurationSource implements Initializable
{
    ...
    {
        super.initialize();
        logger2.info("xwiki.properties JNDI override installed");
    }
